  ...
  return (
    <div className="flex gap-5 flex-wrap">
      {cards.map((cards, index) => (
        <div
          key={index}
          className="flex flex-col gap-1 bg-(--bg-secondary) border-5 border-(--border) p-2 shadow-md hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer hover:text-(--primary)"
        >
          {cards.imageUrl && (
            <div className="m-4">
              <Image
